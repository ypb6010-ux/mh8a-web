...
export const mockStatuses: StatusItem[] = [
  ...
  { name: "Water Trip", state: "blue" },
  { name: "Motor Temp Trip", state: "blue" },
  { name: "Flow Trip", state: "blue" },
  { name: "Oil Temp Trip", state: "blue" },
  { name: "Fan Trip", state: "blue" },
  { name: "Gas Trip", state: "blue" },
  { name: "Leakage Trip", state: "red" },
  { name: "Phase Seq.", state: "blue" },
  { name: "Level Trip", state: "blue" },
  { name: "Volt Phase Loss", state: "blue" },
  { name: "Phase Fault", state: "blue" },
  { name: "Oil Temp Open", state: "blue" },
  { name: "Level Open", state: "blue" },
  { name: "Motor Temp Open", state: "blue" },
  { name: "SC Trip", state: "blue" },
  { name: "E-Stop Trip", state: "blue" },
];
